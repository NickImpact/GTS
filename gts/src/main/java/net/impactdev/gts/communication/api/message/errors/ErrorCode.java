package net.impactdev.gts.communication.api.message.errors;
...
public interface ErrorCode {
     ...
     * a user should be able to hover over the key to receive what is specified by {@link #description()}.
     *
