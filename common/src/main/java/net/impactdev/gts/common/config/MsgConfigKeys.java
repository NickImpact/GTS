...
public class MsgConfigKeys implements ConfigKeyHolder {
	...
	public static final ConfigKey<String> ADMIN_LISTING_EDITOR_DELETE_RETURN_TITLE = stringKey("admin.listing-editor.icons.delete.delete.title", "&aDelete Listing");
	public static final ConfigKey<String> ADMIN_LISTING_EDITOR_DELETE_NORETURN_TITLE = stringKey("admin.listing-editor.icons.delete.delete-and-return.title", "&aDelete Listing");
	public static final ConfigKey<List<String>> ADMIN_LISTING_EDITOR_DELETE_RETURN_LORE = listKey("admin.listing-editor.icons.delete.delete.lore", Lists.newArrayList(

	));
	public static final ConfigKey<List<String>> ADMIN_LISTING_EDITOR_DELETE_NORETURN_LORE = listKey("admin.listing-editor.icons.delete.delete-and-return.lore", Lists.newArrayList(
