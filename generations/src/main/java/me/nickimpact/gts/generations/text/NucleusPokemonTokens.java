...
//		service.register("pokerus_state", placeholder -> service.getOrDefault(placeholder, key, pokemon -> getPokemonInfo(pokemon, EnumPokemonFields.POKERUS_STATE)));
	...
	public static class PokemonKey implements PlaceholderVariables.Key<EntityPixelmon> {
		...
		@Override
		public TypeToken<EntityPixelmon> getValueClass() {
			return new TypeToken<EntityPixelmon>(){};
		}

	}

	private Text getPokemonInfo(EntityPixelmon pokemon, EnumPokemonFields field) {
		if (pokemon != null) {
