...
public class VelocityAuction extends VelocityListing implements Auction {
    ...
    public VelocityAuction(VelocityAuctionBuilder builder) {
    ...
    public static VelocityAuction deserialize(JsonObject object) {
        VelocityAuctionBuilder builder = (VelocityAuctionBuilder) Auction.builder()
    ...
    public static VelocityAuctionBuilder builder() {
        return Impactor.getInstance().getRegistry().createBuilder(VelocityAuctionBuilder.class);
    }

    public static class VelocityAuctionBuilder implements AuctionBuilder {
        ...
        public AuctionBuilder from(Auction input) {
            Preconditions.checkArgument(input instanceof VelocityAuction, "Mixing of invalid types!");
            this.id = input.getID();
        ...
        @Override
        public VelocityAuction build() {
            return new VelocityAuction(this);
        }
    }
}
