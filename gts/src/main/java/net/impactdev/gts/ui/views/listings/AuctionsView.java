...
public final class AuctionsView extends ListingsView {
    @Override
    protected Key key() {
        return GTSKeys.gts("auction-listings");
    }
        ...
        return TemplateRegistration.builder(SectionedPagination.class)
                .config(Config.builder()
                        .path(GTSPlugin.instance()
                                ...
                                .resolve("views")
                                .resolve("auction-listings.conf")
                        )
                        .provider(ListingViewConfigKeys.class)
                        .build()
                )
                .deserializer(AuctionsViewTemplate::new)
                .build();
    }

    private static final class AuctionsViewTemplate extends SectionedPaginationTemplate {
        ...
        AuctionsViewTemplate(Config config) {
        ...
        protected SectionedPagination finalize(SectionedPaginationBuilder builder, Context context) {
            ...
            listings.contents(GTSPlugin.instance().listings()
                    .fetch(listing -> listing instanceof Auction)
                    .stream()
