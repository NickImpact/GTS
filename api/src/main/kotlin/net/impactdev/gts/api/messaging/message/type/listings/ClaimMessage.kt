 ...
 */
interface ClaimMessage : OutgoingMessage {
    /**
     ...
     *
     * If our claim is based around an auction, this request should return an [ClaimMessage.Response.AuctionResponse]
     * that includes the extended information.
     */
    interface Request : ClaimMessage, MessageType.Request<Response?>
     ...
     */
    interface Response : ClaimMessage, MessageType.Response {
        /**
         ...
         */
        interface AuctionResponse : Response {
            /**
             ...
             */
            fun hasOtherBidderClaimed(uuid: UUID?): TriState?
             ...
             */
            val allOtherClaimers: List<UUID?>?
        }
    }
}