 ...
 */
interface BuyItNowMessage : OutgoingMessage {
    /**
     ...
     */
    interface Publish : BuyItNowMessage
     ...
     */
    interface Purchase : BuyItNowMessage {
        /**
         ...
         * and then further respond to the request with a new [Response][Purchase.Response] message.
         */
        interface Request : Purchase, MessageType.Request<Response?>

        /**
         * This message indicates the response to a [Request][Purchase.Request] made prior to this
         ...
         */
        interface Response : Purchase, MessageType.Response {
            /**
    ...
    interface Remove : BuyItNowMessage {
         ...
         */
        fun shouldReturnListing(): Boolean
         ...
         * removal attempt.
         */
        interface Request : Remove, MessageType.Request<Response?>
         ...
         */
        interface Response : Remove, MessageType.Response
    }
}