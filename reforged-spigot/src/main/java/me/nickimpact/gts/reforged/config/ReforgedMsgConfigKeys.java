...
public class ReforgedMsgConfigKeys implements ConfigKeyHolder {
	...
	public static final ConfigKey<List<String>> PE_BASE_HYPERTRAINED = listKey("entry.display.lore.hypertrained", Lists.newArrayList(
			"&cHyper Trained"
	));
	...
	static {
		...
		Field[] values = ReforgedMsgConfigKeys.class.getFields();
		int i = 0;
