package me.nickimpact.gts.api.messaging.message.type.listings;
 ...
 */
public interface QuickPurchaseMessage extends OutgoingMessage {
	 ...
	 */
	interface Publish extends QuickPurchaseMessage {
	 ...
	 */
	interface Purchase extends QuickPurchaseMessage {
		...
		interface Response extends Purchase, MessageType.Response {
			...
			/**
			 * States whether or not this purchase was made successfully. A purchase can really only fail
			 * if the listing was either removed or already purchased.
			 *
			 * @return True if the listing was able to be purchased successfully, false otherwise
			 */
	 ...
	 */
	interface Remove extends QuickPurchaseMessage {
		...
		interface Response extends Remove, MessageType.Response {
			...
			/**
			 * States whether the removal request was made successfully.
			 *
